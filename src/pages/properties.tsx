...
const Properties = () => {
  return (
    ...
    >
      ...
      <CustomHeading heading="Residential Properties" />
      ...
      <CustomHeading heading="Commercial Properties" />
      <div
        style={{
          width: "90%",
          padding: "40px",
      ...
      <CustomHeading heading="Developer / Non- Agricultural  Plots" />
      <VaastuDetailsContainer data={DEVELOPER_PLOTS} />

      <PromotionalBanner data={DEVELOPER_PROPERTIES} />
      {/* Developer carousel */}
      <CustomHeading heading="Location Benefits" />
      <div
        style={{
          width: "90%",
          padding: "40px",
